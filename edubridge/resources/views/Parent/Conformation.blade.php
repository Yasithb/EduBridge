...
<header class="flex items-center justify-between whitespace-nowrap border-b border-gray-200 dark:border-gray-700 px-10 py-4">
...
<h2 class="text-xl font-bold text-gray-900 dark:text-white">School App</h2>
</div>
...
<div class="bg-white dark:bg-background-dark/50 p-8 rounded-lg shadow-lg">
<h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">Welcome Home, Emily!</h1>
<p class="text-gray-600 dark:text-gray-300 mb-8">Please confirm that Emily has arrived home safely.</p>
<button class="w-full max-w-xs mx-auto bg-primary text-white font-bold py-3 px-6 rounded-lg text-lg hover:bg-primary/90 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-primary/30">
                    Confirm Arrival
                </button>
</div>
</div>
