...
<a class="px-3 py-2 rounded-lg text-sm font-medium bg-primary/10 text-primary dark:bg-primary/20" href="{{ route('parent.dashboard') }}">Dashboard</a>
<a class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary transition-colors" href="{{ route('parent.tracker') }}">Attendance</a>
<a class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary transition-colors" href="{{ route('parent.reports') }}">Grades</a>
<a class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary transition-colors" href="{{ route('parent.messages') }}">Messages</a>
<a class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary transition-colors" href="{{ route('parent.notifications') }}">Notifications</a>
</nav>
<div class="flex items-center gap-4">
